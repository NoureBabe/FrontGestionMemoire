...
ValiderDemendeEncadrant(titreSujet: string){
  let headers=new  HttpHeaders({'Authorization':'Bearer '+this.authentiService.jwToken})
  return this.http.get(this.host2+'/ValiderDemendeEncadrant/'+titreSujet, {headers: headers})
}
RefuserDemendeEncadrant(titreSujet: string){
  let headers=new  HttpHeaders({'Authorization':'Bearer '+this.authentiService.jwToken})
  return this.http.get(this.host2+'/RefuserDemendeEncadrant/'+titreSujet, {headers: headers})
}
